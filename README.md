...
17. Run 5 different tasks (steps 1–5 above). After the 5th completes, check **Memory → Summaries** — a conversation summary should appear, auto-generated by the LLM from your recent interactions.
