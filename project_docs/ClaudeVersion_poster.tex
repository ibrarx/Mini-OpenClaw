...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north west, card, text width=168mm, minimum height=88mm, inner sep=5.5mm, align=left]
       (abs) at ($(NW)+(16mm,-92mm)$){};
  ...
  \node[anchor=north west, card, text width=192mm, minimum height=88mm, inner sep=5.5mm, align=left]
  ...
  \node[anchor=north west, text=ink] at ($(NW)+(16mm,-188mm)$){\SecHead What it delivers};
  \fill[teal] ($(NW)+(16mm,-197mm)$) rectangle ($(NW)+(70mm,-198.2mm)$);
  ...
  \node[anchor=north west, tintcard, minimum width=388mm, minimum height=40mm]
       (num) at ($(NW)+(16mm,-254mm)$){};
  \foreach \i/\n/\l in {0/{13 + MCP}/{tools}, 1/{3}/{LLM providers tested}, 2/{5}/{memory layers}}{
    \node[anchor=north, text=tublue] at ($(NW)+(58mm+\i*68mm,-259mm)$){\StatNum \n};
    \node[anchor=north, text=slate] at ($(NW)+(58mm+\i*68mm,-276mm)$){\BodyS \l};
  }
  \draw[line,line width=0.3mm] ($(NW)+(248mm,-260mm)$)--($(NW)+(248mm,-288mm)$);
  \node[anchor=north, text=inkt, text width=140mm, align=center] at ($(NW)+(330mm,-259mm)$){%
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north west, card, minimum width=216mm, minimum height=100mm] (shot) at ($(NW)+(16mm,-38mm)$){};
  ...
  \node[anchor=north west, text=ink] at ($(NW)+(16mm,-142mm)$){\SecHead Where the pipeline earns its cost};
  \node[anchor=north west, text=inkt, text width=388mm, align=left] at ($(NW)+(16mm,-149mm)$){%
...
% chart 1: success rate
  \node[anchor=north west] at ($(NW)+(28mm,-162mm)$){%
    \begin{tikzpicture}[x=1mm,y=1mm, font=\Mini]
...
\node[anchor=north west] at ($(NW)+(160mm,-162mm)$){%
    \begin{tikzpicture}[x=1mm,y=1mm, font=\Mini]
  ...
  \node[anchor=north west] at ($(NW)+(292mm,-162mm)$){%
    \begin{tikzpicture}[x=1mm,y=1mm, font=\Mini]
